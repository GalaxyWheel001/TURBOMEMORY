...
export async function middleware(request: NextRequest) {
  ...
  // Локальная разработка: полностью отключаем редиректы и клоакинг
  ...
  if (host.endsWith('gaminyalanyokt1.netlify.app')) {
    ...
    // Реальные пользователи с рекламной ссылки идут на корень основного сайта
    const targetUrl = new URL('https://bonus-turboplay.bet/');
